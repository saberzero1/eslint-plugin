...
function testJsConfigsRecommendedRules(): void {
...
function testExplicitlyConfiguredRules(): void {
...
function testTseslintEslintRecommendedRules(): void {
...
function getBuiltinRule(name: TestedBuiltinRule): Rule.RuleModule {
